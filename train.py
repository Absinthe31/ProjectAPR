...
json_handler = FileHandler('logs.log')
...
mfcc_input = Input(shape=(12, 5168, 1))

chromagram_input = Input(shape=(12, 5168, 1))
...
conv1 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_1'], 
               input_shape=(12, 5168, 1), activation='relu')(mfcc_input)
...
conv3 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_3'], activation='relu')(drop2)
conv3 = MaxPooling2D(pool_size=params_dict['max_pooling'])(conv3)
drop3 = Dropout(params_dict['dropout'])(conv3)
conv4 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_4'], activation='relu')(drop3)
conv4 = MaxPooling2D(pool_size=params_dict['max_pooling'])(conv4)
drop4 = Dropout(params_dict['dropout'])(conv4)

first_part_output = Flatten()(drop4)

conv6 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_1'], 
               input_shape=(12, 5168, 1), activation='relu')(chromagram_input)
...
conv8 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_3'], activation='relu')(drop7)
conv8 = MaxPooling2D(pool_size=params_dict['max_pooling'])(conv8)
drop8 = Dropout(params_dict['dropout'])(conv8)
conv9 = Conv2D(filters=params_dict['filters'], kernel_size=params_dict['conv_4'], activation='relu')(drop8)
conv9 = MaxPooling2D(pool_size=params_dict['max_pooling'])(conv9)
drop9 = Dropout(params_dict['dropout'])(conv9)

second_part_output = Flatten()(drop9)
...
checkpoint_filepath = './keras_checkpoints/'
